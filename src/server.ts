...
// Parte 3: descomente as linhas marcadas com [P3]
import { CompanyService } from './services/employee.service'  // [P3]
import { CompanyController } from './controllers/employee.controller'  // [P3]
import { companyRoutes } from './router/employee.routes'  // [P3]
import { EmployeeRepository } from './repositories/employee.repository'
import { CompanyRepository } from './repositories/company.repository'
import { errorMiddleware } from './middlewares/error.middleware'
